...
public class Menu extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		/*
		 * Image magicka = new Image(new
		 * ClassLoader().getResource("bg/magicka_2.jpg").toString()); Canvas
		 * canvas = new Canvas(1200, 900);
		 * canvas.getGraphicsContext2D().drawImage(magicka, 0, 0,
		 * magicka.getWidth(), magicka.getHeight(), 0, 0, 1200, 900); scene =
		 * new Scene(new StackPane(canvas, loader.load()));
		 */
	...
	private void setstage(Stage stage) {
		...
		// SequentialTransition trans = new
		// SequentialTransition(transStart,transOption,transExit);
